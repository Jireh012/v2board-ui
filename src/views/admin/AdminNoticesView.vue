...
.edit-modal { width: min(640px, 96vw); }
...
.textarea { resize: vertical; min-height: 120px; line-height: 1.5; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; }
